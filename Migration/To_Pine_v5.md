...
**URL:** https://www.tradingview.com/pine-script-docs/migration-guides/to-pine-version-5/
...
Script v5. See our
[Release notes](/pine-script-docs/release-notes/#october-2021) for a list of the new features in Pine Script v5.
...
[color.new()](https://www.tradingview.com/pine-script-reference/v5/#fun_color%7Bdot%7Dnew)
...
found in the
[Common script conversion errors](/pine-script-docs/migration-guides/to-pine-version-5/#common-script-conversion-errors) section of this guide.
...
[ta.sma()](https://www.tradingview.com/pine-script-reference/v5/#fun_ta%7Bdot%7Dsma).
...
![image](/pine-script-docs/_astro/v5_autocomplete.R-4HP09V_Z1R3GAs.webp)
...
[All variable, function, and parameter name changes](/pine-script-docs/migration-guides/to-pine-version-5/#all-variable-function-and-parameter-name-changes) section of this guide.
...
In v4, the
[rsi()](https://www.tradingview.com/pine-script-reference/v4/#fun_rsi)
...
The
[ta.rsi()](https://www.tradingview.com/pine-script-reference/v5/#fun_ta%7Bdot%7Drsi)
...
[ta.rma()](https://www.tradingview.com/pine-script-reference/v5/#fun_ta%7Bdot%7Drma)
moving average, which is similar to
[ta.ema()](https://www.tradingview.com/pine-script-reference/v5/#fun_ta%7Bdot%7Dema)
...
The
[iff()](https://www.tradingview.com/pine-script-reference/v4/#fun_iff)
and
[offset()](https://www.tradingview.com/pine-script-reference/v4/#fun_offset)
...
a specialized
[input.float()](https://www.tradingview.com/pine-script-reference/v5/#fun_input%7Bdot%7Dfloat)
...
`input.symbol`, the
[input.symbol()](https://www.tradingview.com/pine-script-reference/v5/#fun_input%7Bdot%7Dsymbol)
...
[security()](https://www.tradingview.com/pine-script-reference/v4/#fun_security)
...
[color.new()](https://www.tradingview.com/pine-script-reference/v5/#fun_color%7Bdot%7Dnew)
or
[color.rgb()](https://www.tradingview.com/pine-script-reference/v5/#fun_color%7Bdot%7Drgb)
...
[input.session()](https://www.tradingview.com/pine-script-reference/v5/#fun_input%7Bdot%7Dsession),
...
[strategy.exit()](https://www.tradingview.com/pine-script-reference/v5/#fun_strategy%7Bdot%7Dexit)
...
See the
[Some function parameters now require built-in arguments](/pine-script-docs/migration-guides/to-pine-version-5/#some-function-parameters-now-require-built-in-arguments) section of this guide for more information.

### [Undeclared identifier ‘input.%input_name%’](#undeclared-identifier-inputinput_name)
...
See the User Manual’s page on [Inputs](/pine-script-docs/concepts/inputs/), and the
[Some function parameters now require built-in arguments](/pine-script-docs/migration-guides/to-pine-version-5/#some-function-parameters-now-require-built-in-arguments) section of this guide for more information.
...
[strategy.entry()](https://www.tradingview.com/pine-script-reference/v5/#fun_strategy%7Bdot%7Dentry)
and
[strategy.close()](https://www.tradingview.com/pine-script-reference/v5/#fun_strategy%7Bdot%7Dclose).
...
[- Introduction
](#introduction)[- v4 to v5 converter
](#v4-to-v5-converter)[- Renamed functions and variables
](#renamed-functions-and-variables)[- Renamed function parameters
](#renamed-function-parameters)[- Removed an `rsi()` overload
](#removed-an-rsi-overload)[- Reserved keywords
](#reserved-keywords)[- Removed `iff()` and `offset()`
](#removed-iff-and-offset)[- Split of `input()` into several functions
](#split-of-input-into-several-functions)[- Some function parameters now require built-in arguments
](#some-function-parameters-now-require-built-in-arguments)[- Deprecated the `transp` parameter
](#deprecated-the-transp-parameter)[- Changed the default session days for `time()` and `time_close()`
](#changed-the-default-session-days-for-time-and-time_close)[- `strategy.exit()` now must do something
](#strategyexit-now-must-do-something)[- Common script conversion errors
](#common-script-conversion-errors)[- Invalid argument ‘style’/‘linestyle’ in ‘plot’/‘hline’ call
](#invalid-argument-stylelinestyle-in-plothline-call)[- Undeclared identifier ‘input.%input_name%’
](#undeclared-identifier-inputinput_name)[- Invalid argument ‘when’ in ‘strategy.close’ call
](#invalid-argument-when-in-strategyclose-call)[- Cannot call ‘input.int’ with argument ‘minval’=‘%value%‘. An argument of ‘literal float’ type was used but a ‘const int’ is expected
](#cannot-call-inputint-with-argument-minvalvalue-an-argument-of-literal-float-type-was-used-but-a-const-int-is-expected)[- All variable, function, and parameter name changes
](#all-variable-function-and-parameter-name-changes)[- Removed functions and variables
](#removed-functions-and-variables)[- Renamed functions and parameters
](#renamed-functions-and-parameters)[- No namespace change
](#no-namespace-change)[- ”ta” namespace for technical analysis functions and variables
](#ta-namespace-for-technical-analysis-functions-and-variables)[- ”math” namespace for math-related functions and variables
](#math-namespace-for-math-related-functions-and-variables)[- ”request” namespace for functions that request external data
](#request-namespace-for-functions-that-request-external-data)[- ”ticker” namespace for functions that help create tickers
](#ticker-namespace-for-functions-that-help-create-tickers)[- ”str” namespace for functions that manipulate strings
](#str-namespace-for-functions-that-manipulate-strings) [      ](#top)           -  [Pine Q&A chat](https://www.tradingview.com/chat/#BfmVowG1TZkKO235)  
