...
**URL:** https://www.tradingview.com/pine-script-docs/migration-guides/to-pine-version-6/
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-Convert-button.BbP6b2UG_ZIeE3O.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-Dynamic-requests.CU--JEtI_Z1wsCBX.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-No-bool-na-1.B7b5WX8__ZhfW1O.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-No-bool-na-2.BCM2Ys_b_Z1lBgK8.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-No-bool-na-3.C2oMRPfl_ZJu6OY.webp)
...
Some Pine Script function parameters expect values of unique types. For example, the `style` parameter of the [plot()](https://www.tradingview.com/pine-script-reference/v6/#fun_plot) function expects a value of the “input plot_style” qualified type, which must be one of the constants in the `plot.style_*` group.
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-No-enum-na.Rirf8rCY_ZFlyGA.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-No-int-division-1.vzmEC1NZ_ZLqSka.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-No-int-division-2.DNd_hajv_1TwdjI.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-Color-changes.BNSaJyQ-_Zq4WdJ.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-Margin-calls-1.CnzpPLkm_1lRc8h.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-Margin-calls-2.DY4IZ4xs_ZukbpG.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-Order-trimming.CFIVLCGx_Z2iQqmO.webp)
...
![image](/pine-script-docs/_astro/To-pine-version-6-Strategies-Strategy-exit-evaluates-parameter-pairs-1.Bq0Yb_zb_jLvAa.webp)
...
![image](/pine-script-docs/_astro/To-pine-version-6-Strategies-Strategy-exit-evaluates-parameter-pairs-2.Q464KiWa_Z2rlE7N.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-History-for-literals-1.CQYj6Sq2_ZChn43.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-History-for-literals-2.DnTquvm7_1nXvDJ.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-History-for-UDTs.h94G4ccp_wdX75.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-Timeframe-multiplier.C0vAAkQ8_ZbC7c2.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-Lazy-evaluation.DTwy6SAe_64SBs.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-No-series-offset.DH-Z-RyE_Z1mLK8f.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-Minimum-linewidth-1.DK4UaZ1K_ZBnFll.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-Minimum-linewidth-2.BTZsUVkx_VCJPf.webp)
...
![image](/pine-script-docs/_astro/MigrationGuideTov6-Transp-removed.UbKaK0oO_ZOtPJe.webp)
...
![image](/pine-script-docs/_astro/To-pine-version-6-Dynamic-for-loop-boundaries-1.n43JfWKr_19ifCF.webp)
...
![image](/pine-script-docs/_astro/To-pine-version-6-Dynamic-for-loop-boundaries-2.XWLzv4MJ_Z1AU5wL.webp)
...
####       Overview  
 ...
 ](/pine-script-docs/migration-guides/overview)  [ Next
...
[- Introduction
](#introduction)[- Converting v5 to v6 using the Pine Editor
](#converting-v5-to-v6-using-the-pine-editor)[- Dynamic requests
](#dynamic-requests)[- Types
](#types)[- Explicit “bool” casting
](#explicit-bool-casting)[- Boolean values cannot be `na`
](#boolean-values-cannot-be-na)[- Unique parameters cannot be `na`
](#unique-parameters-cannot-be-na)[- Constants
](#constants)[- Fractional division of constants
](#fractional-division-of-constants)[- Mutable variables are always “series”
](#mutable-variables-are-always-series)[- Color changes
](#color-changes)[- Strategies
](#strategies)[- Removal of `when` parameter
](#removal-of-when-parameter)[- Default margin percentage
](#default-margin-percentage)[- Excess orders are trimmed
](#excess-orders-are-trimmed)[- `strategy.exit()` evaluates parameter pairs
](#strategyexit-evaluates-parameter-pairs)[- History-referencing operator
](#history-referencing-operator)[- No history for literal values
](#no-history-for-literal-values)[- History of UDT fields
](#history-of-udt-fields)[- Timeframes must include a multiplier
](#timeframes-must-include-a-multiplier)[- Lazy evaluation of conditions
](#lazy-evaluation-of-conditions)[- Cannot repeat parameters
](#cannot-repeat-parameters)[- No series `offset` values
](#no-series-offset-values)[- Minimum `linewidth` is 1
](#minimum-linewidth-is-1)[- Negative indices in arrays
](#negative-indices-in-arrays)[- The `transp` parameter is removed
](#the-transp-parameter-is-removed)[- Dynamic `for` loop boundaries
](#dynamic-for-loop-boundaries) [      ](#top)           -  [Pine Q&A chat](https://www.tradingview.com/chat/#BfmVowG1TZkKO235)  
