...
**URL:** https://www.tradingview.com/pine-script-docs/visuals/colors/
...
![image](/pine-script-docs/_astro/Colors-Constant-colors-1.CnlC-u-k_1ibe2x.webp)
...
![image](/pine-script-docs/_astro/Colors-ConditionalColors-1.D1QaF3Y-_ZumNWi.webp)
...
[ternary operator](/pine-script-docs/language/operators/#-ternary-operator)
...
![image](/pine-script-docs/_astro/Colors-ConditionalColors-2.erY98c4P_Z1OwyIO.webp)
...
![image](/pine-script-docs/_astro/Colors-CalculatingColors-1.BtEyXAO2_Z2dfpcb.webp)
...
![image](/pine-script-docs/_astro/Colors-CalculatingColors-2.B7PJa61g_ZI19Ev.webp)
...
### [color.from_gradient()](#colorfrom_gradient)
...
![image](/pine-script-docs/_astro/Colors-CalculatingColors-3.BWe7BFsC_Zg2kjC.webp)
...
![image](/pine-script-docs/_astro/Colors-CalculatingColors-4.-U0l6lwc_Zd5X5K.webp)
...
![image](/pine-script-docs/_astro/Colors-MixingTransparencies-1.DJ-yTBxm_1VcSbJ.webp)

And with the dark theme:

![image](/pine-script-docs/_astro/Colors-MixingTransparencies-2.BJOvmETq_Z1CqQBv.webp)
...
![image](/pine-script-docs/_astro/Colors-MaintainAutomaticColorSelection-1.BHISUteP_LNVpG.webp)
...
![image](/pine-script-docs/_astro/Colors-MaintainAutomaticColorSelection-2.BO3w97fq_14utEv.webp)

![image](/pine-script-docs/_astro/Colors-MaintainAutomaticColorSelection-3.B0TUMw_p_Z2hnihX.webp)
...
![image](/pine-script-docs/_astro/Colors-MaintainAutomaticColorSelection-4.B7QSrDzd_18UfnH.webp)
...
![image](/pine-script-docs/_astro/Colors-PlotCrispLines-1.CJkrlPd__Z1Me4S0.webp)
...
####       Bar plotting  
 ...
 ](/pine-script-docs/visuals/bar-plotting)  [ Next
...
[- Introduction
](#introduction)[- Transparency
](#transparency)[- Constant colors
](#constant-colors)[- Conditional coloring
](#conditional-coloring)[- Calculated colors
](#calculated-colors)[- color.new()
](#colornew)[- color.rgb()
](#colorrgb)[- color.from_gradient()
](#colorfrom_gradient)[- Mixing transparencies
](#mixing-transparencies)[- Tips
](#tips)[- Maintaining automatic color selectors
](#maintaining-automatic-color-selectors)[- Designing usable colors schemes
](#designing-usable-colors-schemes)[- Plot crisp lines
](#plot-crisp-lines)[- Customize gradients
](#customize-gradients) [      ](#top)           -  [Pine Q&A chat](https://www.tradingview.com/chat/#BfmVowG1TZkKO235)  
