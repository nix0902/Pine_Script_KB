...
![image](/pine-script-docs/_astro/User-defined-functions-Structure-and-syntax-Single-line-functions-1.ZUSKhP6e_ZKc48j.webp)
...
![image](/pine-script-docs/_astro/User-defined-functions-Structure-and-syntax-Single-line-functions-2.BetlAr8S_1ryqEl.webp)
...
![image](/pine-script-docs/_astro/User-defined-functions-Structure-and-syntax-Multiline-functions-1.BxkB4CE1_Zoo4No.webp)
...
![image](/pine-script-docs/_astro/User-defined-functions-Functions-that-return-multiple-results-1.CVZCb-PO_15cSiL.webp)
...
In some cases, a script might not require all the results from the tuple returned by a function call. Instead of writing unique identifiers for every variable in the tuple declaration, programmers can [use an underscore](/pine-script-docs/language/variable-declarations/#using-an-underscore-as-an-identifier) as the identifier for each variable that the script does not require. All variables with the name `_` are not usable in the script’s calculations.
...
![image](/pine-script-docs/_astro/User-defined-functions-Declaring-parameter-types-Type-keywords-1.zDkkXyfc_9KdIq.webp)
...
![image](/pine-script-docs/_astro/User-defined-functions-Declaring-parameter-types-Qualifier-keywords-1.UmWjQFYB_Z1fknjB.webp)
...
![image](/pine-script-docs/_astro/User-defined-functions-Declaring-parameter-types-Qualifier-keywords-2.3l-V8A-N_Z29evjm.webp)
...
![image](/pine-script-docs/_astro/User-defined-functions-Declaring-parameter-types-Qualifier-keywords-3.CmT8Y_eI_IzVCv.webp)
...
![image](/pine-script-docs/_astro/User-defined-functions-Function-scopes-1.WDscmOKC_ZNJHOw.webp)
...
![image](/pine-script-docs/_astro/User-defined-functions-Function-scopes-2.CcNLbFZI_7foTM.webp)
...
![image](/pine-script-docs/_astro/User-defined-functions-Function-scopes-Scope-of-a-function-call-1.BvL7oJKj_1893SS.webp)
...
![image](/pine-script-docs/_astro/User-defined-functions-Function-scopes-Scope-of-a-function-call-2.BKLDlUMm_HXY3e.webp)
...
![image](/pine-script-docs/_astro/User-defined-functions-Function-overloading-1.BTe80Gur_Z1svM3v.webp)
...
![image](/pine-script-docs/_astro/User-defined-functions-Function-overloading-2.CU45Rhl7_ZRpVfS.webp)
...
####       Built-ins  
 ...
 ](/pine-script-docs/language/built-ins)  [ Next
...
](#structure-and-syntax)[- Single-line functions
](#single-line-functions)[- Multiline functions
](#multiline-functions)[- Functions that return multiple results
](#functions-that-return-multiple-results)[- Declaring parameter types
](#declaring-parameter-types)[- Type keywords
](#type-keywords)[- Qualifier keywords
](#qualifier-keywords)[- Documenting functions
](#documenting-functions)[- Function scopes
](#function-scopes)[- Scope of a function call
](#scope-of-a-function-call)[- Function overloading
](#function-overloading)[- Limitations
](#limitations)[- No global-only built-in function calls
](#no-global-only-built-in-function-calls)[- Consistent types for each call
](#consistent-types-for-each-call)[- Cannot modify global variables or parameters
](#cannot-modify-global-variables-or-parameters)[- No nested definitions
](#no-nested-definitions)[- No recursive functions
](#no-recursive-functions) [      ](#top)           -  [Pine Q&A chat](https://www.tradingview.com/chat/#BfmVowG1TZkKO235)  
