...
- [To Pine Script® version 2](/pine-script-docs/migration-guides/to-pine-version-2)
- [Where can I get more information?](/pine-script-docs/where-can-i-get-more-information)
             [ User Manual  ](/pine-script-docs)  / [Language](/pine-script-docs/language/execution-model) / Maps   ADVANCED     
# [Maps](#maps)
...
![image](/pine-script-docs/_astro/Maps-Declaring-a-map-Using-var-and-varip-keywords-1.DMKyDQUN_ZNaztD.webp)
...
![image](/pine-script-docs/_astro/Maps-Reading-and-writing-Putting-and-getting-key-value-pairs-1.CnULguMa_ZMFlOi.webp)
...
[next section](/pine-script-docs/language/maps/#inspecting-keys-and-values).
...
or a
[user-defined type](/pine-script-docs/language/type-system/#user-defined-types) into a map, it’s important to note the inserted pair’s
...
![image](/pine-script-docs/_astro/Maps-Reading-and-writing-Putting-and-getting-key-value-pairs-2.wNHX2-4R_Z21EdVP.webp)
...
[Copying objects](/pine-script-docs/language/objects/#copying-objects) section of the [Objects](/pine-script-docs/language/objects/) page.
...
and
[map.values()](https://www.tradingview.com/pine-script-reference/v6/#fun_map.values)
functions always return [arrays](/pine-script-docs/language/arrays/) with their elements ordered based on the `id` map’s
insertion order.
...
![image](/pine-script-docs/_astro/Maps-Reading-and-writing-Inspecting-keys-and-values-1.BtySOORc_ZqH8ET.webp)
...
[removes](/pine-script-docs/language/maps/#removing-key-value-pairs) the key beforehand.
...
![image](/pine-script-docs/_astro/Maps-Reading-and-writing-Inspecting-keys-and-values-2.CRhK5y_B_Z25ivPS.webp)
...
![image](/pine-script-docs/_astro/Maps-Reading-and-writing-Inspecting-keys-and-values-3.BFc856qo_2slIVc.webp)
...
[contained](/pine-script-docs/language/maps/#mapcontains) the specified `key`. Otherwise, it returns
[na](https://www.tradingview.com/pine-script-reference/v6/#var_na).
...
[puts](/pine-script-docs/language/maps/#putting-and-getting-key-value-pairs) key-value pairs into the map, uses
...
![image](/pine-script-docs/_astro/Maps-Reading-and-writing-Removing-key-value-pairs-1.vUrgRJdK_Z11m7iy.webp)
...
calls
[map.put_all()](https://www.tradingview.com/pine-script-reference/v6/#fun_map.put_all) as a method
...
![image](/pine-script-docs/_astro/Maps-Reading-and-writing-Combining-maps-1.pxWmo3rc_Z1eFido.webp)
...
![image](/pine-script-docs/_astro/Maps-Looping-through-a-map-1.CTALDkOv_261pAn.webp)
...
![image](/pine-script-docs/_astro/Maps-Copying-a-map-Shallow-copies-1.e7-GYyqa_2eTTgn.webp)
...
While a [shallow copy](/pine-script-docs/language/maps/#shallow-copies) will suffice when copying maps that have values of a
[fundamental type](/pine-script-docs/language/type-system/#types) or [enum type](/pine-script-docs/language/type-system/#enum-types), it’s crucial to understand that shallow copies of a map with elements of a reference type
([line](https://www.tradingview.com/pine-script-reference/v6/#type_line),
[linefill](https://www.tradingview.com/pine-script-reference/v6/#type_linefill),
[box](https://www.tradingview.com/pine-script-reference/v6/#type_box),
[polyline](https://www.tradingview.com/pine-script-reference/v6/#type_polyline),
...
[table](https://www.tradingview.com/pine-script-reference/v6/#type_table),
[chart.point](https://www.tradingview.com/pine-script-reference/v6/#type_chart.point)
or a [UDT](/pine-script-docs/language/type-system/#user-defined-types)) point to the same objects as the original. Modifying the
...
[label](https://www.tradingview.com/pine-script-reference/v6/#type_label)
value elements, then
[puts](/pine-script-docs/language/maps/#putting-and-getting-key-value-pairs)
...
![image](/pine-script-docs/_astro/Maps-Copying-a-map-Deep-copies-1.DxdX2Bvp_23djFR.webp)
...
[putting](/pine-script-docs/language/maps/#putting-and-getting-key-value-pairs) key-value pairs containing the copies into a new
map instance.
...
![image](/pine-script-docs/_astro/Maps-Scope-and-history-1.D57XNJl__ZkKAgd.webp)
...
[arrays](/pine-script-docs/language/arrays/), or
[matrices](/pine-script-docs/language/matrices/) as value elements, but
they can hold references to objects of a
[user-defined type](/pine-script-docs/language/type-system/#user-defined-types) whose fields can reference other collections.
...
![image](/pine-script-docs/_astro/Maps-Maps-of-other-collections-1.DtwJ2MOI_Z172Q8n.webp)
...
](#introduction)[- Declaring a map
](#declaring-a-map)[- Using `var` and `varip` keywords
](#using-var-and-varip-keywords)[- Reading and writing
](#reading-and-writing)[- Putting and getting key-value pairs
](#putting-and-getting-key-value-pairs)[- Inspecting keys and values
](#inspecting-keys-and-values)[- `map.keys()` and `map.values()`
](#mapkeys-and-mapvalues)[- `map.contains()`
](#mapcontains)[- Removing key-value pairs
](#removing-key-value-pairs)[- Combining maps
](#combining-maps)[- Looping through a map
](#looping-through-a-map)[- Copying a map
](#copying-a-map)[- Shallow copies
](#shallow-copies)[- Deep copies
](#deep-copies)[- Scope and history
](#scope-and-history)[- Maps of other collections
](#maps-of-other-collections) [      ](#top)           -  [Pine Q&A chat](https://www.tradingview.com/chat/#BfmVowG1TZkKO235)  
