...
- [To Pine Script® version 2](/pine-script-docs/migration-guides/to-pine-version-2)
- [Where can I get more information?](/pine-script-docs/where-can-i-get-more-information)
             [ User Manual  ](/pine-script-docs)  / [Language](/pine-script-docs/language/execution-model) / Enums   ADVANCED     
# [Enums](#enums)
...
types, or
[enum types](/pine-script-docs/language/type-system/#enum-types), are unique data types with all possible values (members)
...
[collections](/pine-script-docs/language/type-system/#collections) can accept, allowing more strict control over the values
...
[Enum inputs](/pine-script-docs/concepts/inputs/#enum-input) display enum field titles within their dropdown menus in a
...
[this section](/pine-script-docs/language/enums/#utilizing-field-titles) below for more information.

While the above syntax may look similar to the syntax for declaring
[user-defined types (UDTs)](/pine-script-docs/language/type-system/#user-defined-types), it’s crucial to understand that
[enum types](/pine-script-docs/language/type-system/#enum-types) and
[UDTs](/pine-script-docs/language/type-system/#user-defined-types)
serve different purposes. Scripts use
[UDTs](/pine-script-docs/language/type-system/#user-defined-types)
to create [objects](/pine-script-docs/language/objects/) with
...
[enum type](/pine-script-docs/language/type-system/#enum-types). Any variable declared with this type accepts only these members or [na](https://www.tradingview.com/pine-script-reference/v6/#var_na):
...
[enum type](/pine-script-docs/language/type-system/#enum-types):
...
[conditional structures](/pine-script-docs/language/conditional-structures/), allowing the convenient creation of logical patterns with a
...
![image](/pine-script-docs/_astro/Enums-Using-enums-1.nGh65GZL_1UbRFt.webp)
...
[enum type](/pine-script-docs/language/type-system/#enum-types), even if the fields have identical names and titles.
...
![image](/pine-script-docs/_astro/Enums-Using-enums-Utilizing-field-titles-1.AzP84EB1_1aSLkU.webp)
...
[enum inputs](/pine-script-docs/concepts/inputs/#enum-input).
...
[maps](/pine-script-docs/language/maps/), as unlike other
non-fundamental [types](/pine-script-docs/language/type-system/#types), scripts can declare [maps](/pine-script-docs/language/maps/) with keys of an
[enum type](/pine-script-docs/language/type-system/#enum-types), enabling strict control over all possible keys allowed in
...
![image](/pine-script-docs/_astro/Enums-Collecting-enums-1.ZTw8lVuz_1tEOAf.webp)
...
[this section](/pine-script-docs/language/maps/#mapkeys-and-mapvalues) of the [Maps](/pine-script-docs/language/maps/) page for more information.
...
[Reducing drawing updates](/pine-script-docs/writing/profiling-and-optimization/#reducing-drawing-updates) section of the
[Profiling and optimization](/pine-script-docs/writing/profiling-and-optimization/) page to learn more.
...
####       Objects  
 ...
 ](/pine-script-docs/language/objects)  [ Next
...
](#introduction)[- Declaring an enum
](#declaring-an-enum)[- Using enums
](#using-enums)[- Utilizing field titles
](#utilizing-field-titles)[- Collecting enum members
](#collecting-enum-members)[- Shadowing
](#shadowing) [      ](#top)           -  [Pine Q&A chat](https://www.tradingview.com/chat/#BfmVowG1TZkKO235)  
