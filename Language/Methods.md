...
- [To Pine Script® version 2](/pine-script-docs/migration-guides/to-pine-version-2)
- [Where can I get more information?](/pine-script-docs/where-can-i-get-more-information)
             [ User Manual  ](/pine-script-docs)  / [Language](/pine-script-docs/language/execution-model) / Methods   ADVANCED     
# [Methods](#methods)

## [Introduction](#introduction)

Pine Script methods are specialized functions associated with values of specific [built-in types](/pine-script-docs/language/type-system/#types),
[user-defined types](/pine-script-docs/language/type-system/#user-defined-types), or [enum types](/pine-script-docs/language/type-system/#enum-types).
...
Pine Script features built-in methods for most [special types](/pine-script-docs/language/type-system/#types),
including
...
[chart.point](https://www.tradingview.com/pine-script-reference/v6/#type_chart.point), [footprint](https://www.tradingview.com/pine-script-reference/v6/#type_footprint), and [volume_row](https://www.tradingview.com/pine-script-reference/v6/#type_volume_row).
...
![image](/pine-script-docs/_astro/Methods_custom_bb.DR1SlFGg_2tQfSW.webp)
...
[compiler annotation](/pine-script-docs/language/script-structure/#compiler-annotations) to document method descriptions.
...
[set_text()](https://www.tradingview.com/pine-script-reference/v6/#fun_label.set_text)
method:

![image](/pine-script-docs/_astro/Methods_overloads_type_inspection.BxAK0zpG_2p2qvn.webp)
...
![image](/pine-script-docs/_astro/Methods_empirical_distribution.BdS9hiv6_Z1t1cl8.webp)
...
####       Enums  
 ...
 ](/pine-script-docs/language/enums)  [ Next
...
](#method-overloading)[- Advanced example
](#advanced-example) [      ](#top)           -  [Pine Q&A chat](https://www.tradingview.com/chat/#BfmVowG1TZkKO235)  
