...
**URL:** https://www.tradingview.com/pine-script-docs/language/script-structure/
...
<declaration_statement><code>

## [Version](#version)

A
[compiler annotation](/pine-script-docs/language/script-structure/#compiler-annotations) in the following form tells the compiler which of the
...
[comments](/pine-script-docs/language/script-structure/#comments)
or
[compiler annotations](/pine-script-docs/language/script-structure/#compiler-annotations) are statements, which implement the script’s algorithm. A
...
- [built-in function call](/pine-script-docs/language/built-ins/#built-in-functions),
[user-defined function call](/pine-script-docs/language/user-defined-functions/) or
[a library function call](/pine-script-docs/concepts/libraries/#using-a-library)
...
[wrapped](/pine-script-docs/language/script-structure/#line-wrapping) (continued on multiple lines). Multiple one-line
...
![image](/pine-script-docs/_astro/ScriptStructure-CompilerAnnotations01.CdT2JzaQ_2sKSpL.webp)
...
####       Type system  
 ...
 ](/pine-script-docs/language/type-system)  [ Next
...
[- Overview
](#script-structure)[- Version
](#version)[- Declaration statement
](#declaration-statement)[- Code
](#code)[- Comments
](#comments)[- Line wrapping
](#line-wrapping)[- Compiler annotations
](#compiler-annotations) [      ](#top)           -  [Pine Q&A chat](https://www.tradingview.com/chat/#BfmVowG1TZkKO235)  
