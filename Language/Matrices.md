...
**URL:** https://www.tradingview.com/pine-script-docs/language/matrices/
...
- [To Pine Script® version 2](/pine-script-docs/migration-guides/to-pine-version-2)
- [Where can I get more information?](/pine-script-docs/where-can-i-get-more-information)
             [ User Manual  ](/pine-script-docs)  / [Language](/pine-script-docs/language/execution-model) / Matrices   ADVANCED     
# [Matrices](#matrices)
...
![image](/pine-script-docs/_astro/Matrices-Declaring-a-matrix-Using-var-and-varip-keywords-1.DaUqe-zB_10ShDW.webp)
...
![image](/pine-script-docs/_astro/Matrices-Reading-and-writing-matrix-elements-1.Cpd5xwu1_Z2j5Ymv.webp)
...
![image](/pine-script-docs/_astro/Matrices-Reading-and-writing-matrix-elements-2.EKhiO87r_27PkSE.webp)
...
![image](/pine-script-docs/_astro/Matrices-Rows-and-columns-Retrieving-1.BTrlXXxp_Zjj8GI.webp)
...
Modifications to the [arrays](/pine-script-docs/language/arrays/)
...
![image](/pine-script-docs/_astro/Matrices-Rows-and-columns-Retrieving-2.CJgBcT5Y_1sKqb7.webp)
...
[matrix.add_row()](https://www.tradingview.com/pine-script-reference/v6/#fun_matrix.add_row)
and
[matrix.add_col()](https://www.tradingview.com/pine-script-reference/v6/#fun_matrix.add_col) as
...
![image](/pine-script-docs/_astro/Matrices-Rows-and-columns-Inserting-1.SBCXGGVm_ZyieEL.webp)
...
[Inserting](/pine-script-docs/language/matrices/#inserting) section above:
...
![image](/pine-script-docs/_astro/Matrices-Rows-and-columns-Removing-1.Bi1zJWmd_ZpgTSa.webp)
...
[removing](/pine-script-docs/language/matrices/#removing) section. The following lines swap the first and last rows of the `m` matrix and display the
...
![image](/pine-script-docs/_astro/Matrices-Rows-and-columns-Swapping-1.CEKWu0X8_ZXVDWE.webp)

### [Replacing](#replacing)

It may be desirable in some cases to completely replace a row or
column in a matrix. To do so,
[insert](/pine-script-docs/language/matrices/#inserting) another array’s elements at the desired `row/column` and
[remove](/pine-script-docs/language/matrices/#removing) the old elements previously at that index.
...
![image](/pine-script-docs/_astro/Matrices-Rows-and-columns-Replacing-1.DOIpvAMN_ZBuSGC.webp)
...
[method](/pine-script-docs/language/methods/) that visualizes
...
![image](/pine-script-docs/_astro/Matrices-Looping-through-a-matrix-For-1.AD9eoMUJ_ZEOwGG.webp)
...
[arrays](/pine-script-docs/language/arrays/) in a matrix, making
...
![image](/pine-script-docs/_astro/Matrices-Looping-through-a-matrix-For-in-1.DsFiIU_K_Z1Fdgid.webp)
...
![image](/pine-script-docs/_astro/Matrices-Copying-a-matrix-Shallow-copies-1.Bwmv7fvt_Z2gUKoY.webp)
...
[chart.point](https://www.tradingview.com/pine-script-reference/v6/#type_chart.point))
or
[user-defined types](/pine-script-docs/language/type-system/#user-defined-types), the elements of a shallow copy reference the same objects
...
![image](/pine-script-docs/_astro/Matrices-Copying-a-matrix-Shallow-copies-2.CimkBVuC_XKEfb.webp)
...
[`for` loops](/pine-script-docs/language/matrices/#for) to assign all elements to copies of the originals. When the
...
![image](/pine-script-docs/_astro/Matrices-Copying-a-matrix-Deep-copies-1.DxEfU-j0_1Lkpmy.webp)
...
[shallow copy](/pine-script-docs/language/matrices/#shallow-copies) of an existing matrix that only includes the rows and
...
![image](/pine-script-docs/_astro/Matrices-Copying-a-matrix-Submatrices-1.BTbnoi2I_Z7HBh.webp)
...
[user-defined functions](/pine-script-docs/language/user-defined-functions/),
[methods](/pine-script-docs/language/methods/#user-defined-methods), and
[conditional structures](/pine-script-docs/language/conditional-structures/).
...
![image](/pine-script-docs/_astro/Matrices-Scope-and-history-1.iA9FQFRn_Z1tlC9r.webp)
...
[Matrix calculations](/pine-script-docs/language/matrices/#matrix-calculations) section below.
...
![image](/pine-script-docs/_astro/Matrices-Inspecting-a-matrix-1.CnldBvch_25YXn4.webp)
...
![image](/pine-script-docs/_astro/Matrices-Manipulating-a-matrix-Reshaping-1.DYGzopbC_Z2j7E98.webp)
...
![image](/pine-script-docs/_astro/Matrices-Manipulating-a-matrix-Reversing-1.Cgfm4aYH_1ccxk3.webp)
...
![image](/pine-script-docs/_astro/Matrices-Manipulating-a-matrix-Transposing-1.DLTkeyZ__ZDefeU.webp)
...
([order.ascending](https://www.tradingview.com/pine-script-reference/v6/#var_order.ascending)
...
![image](/pine-script-docs/_astro/Matrices-Manipulating-a-matrix-Sorting-1.7v_kYwQL_ZOu1j2.webp)
...
[matrix.sort()](https://www.tradingview.com/pine-script-reference/v6/#fun_matrix.sort)
method to sort the
[transpose](/pine-script-docs/language/matrices/#transposing)
...
![image](/pine-script-docs/_astro/Matrices-Manipulating-a-matrix-Sorting-2.BaU7IEP__2g88Bo.webp)
...
appended to another,
[transpose](/pine-script-docs/language/matrices/#transposing) both matrices, use
[matrix.concat()](https://www.tradingview.com/pine-script-reference/v6/#fun_matrix.concat)
...
![image](/pine-script-docs/_astro/Matrices-Manipulating-a-matrix-Concatenating-1.Dk8fPc4l_1FGbFm.webp)
...
[submatrices](/pine-script-docs/language/matrices/#submatrices), and its
[rows and columns](/pine-script-docs/language/matrices/#rows-and-columns) using the same syntax. For example, the built-in `*.avg()`
...
![image](/pine-script-docs/_astro/Matrices-Matrix-calculations-Element-wise-calculations-1.qqvZC3jo_uJ39n.webp)
...
by multiplying the values of [matrix.avg()](https://www.tradingview.com/pine-script-reference/v6/#fun_matrix.avg) and [matrix.elements_count()](https://www.tradingview.com/pine-script-reference/v6/#fun_matrix.elements_count).
...
![image](/pine-script-docs/_astro/Matrices-Matrix-calculations-Special-calculations-1.CqDsJl37_RrqVF.webp)
...
![image](/pine-script-docs/_astro/Matrices-Matrix-calculations-Special-calculations-2.B9VMtj33_ZXAisD.webp)
...
[inverse](/pine-script-docs/language/matrices/#matrixinv-and-matrixpinv),
...
[Cramer’s rule](https://en.wikipedia.org/wiki/Cramer). The
...
5 * x0 - 2 * x1 + 1 * x2 = 42 * x0 - 2 * x1 + 1 * x2 = 1
The solution to this system is `(x0 = 1, x1 = 2, x2 = 3)`. The script
calculates these values from `m` via `m.solve()` and plots them on the
chart:

![image](/pine-script-docs/_astro/Matrices-Matrix-calculations-Special-calculations-3.Bq84ZoEi_1X2sQR.webp)
...
matrix when
[multiplied](/pine-script-docs/language/matrices/#matrixmult) by the original. Inverses have use in various matrix
...
regardless of whether the matrix is square or has a nonzero [determinant](/pine-script-docs/language/matrices/#matrixdet), via the
[matrix.pinv()](https://www.tradingview.com/pine-script-reference/v6/#fun_matrix.pinv)
...
![image](/pine-script-docs/_astro/Matrices-Matrix-calculations-Special-calculations-4.BXfICGI-_Z1Y52Ud.webp)
...
![image](/pine-script-docs/_astro/Matrices-Matrix-calculations-Special-calculations-5.DU77KrgW_Z14e0aC.webp)
...
- The
[determinants](/pine-script-docs/language/matrices/#matrixdet) of full-rank square matrices are nonzero, and such
matrices have
[inverses](/pine-script-docs/language/matrices/#matrixinv-and-matrixpinv). Conversely, the determinant of a rank-deficient matrix is always 0.
...
[rows and columns](/pine-script-docs/language/matrices/#rows-and-columns) of a matrix.
...
[matrix.add_col()](https://www.tradingview.com/pine-script-reference/v6/#fun_matrix.add_col)
functions to
[insert](/pine-script-docs/language/matrices/#inserting) rows and columns into a non-empty matrix, the size of the
...
[inserts](/pine-script-docs/language/matrices/#inserting) 1000 rows with 101 elements into the `m` matrix:
...
### [The row/column index must be 0 <= from_row/column < to_row/column.](#the-rowcolumn-index-must-be-0--from_rowcolumn--to_rowcolumn)
...
[submatrix](/pine-script-docs/language/matrices/#submatrices) from a 4x4 `m` matrix with a `from_row` value of 2 and a
...
When using
[matrix.sum() and matrix.diff()](/pine-script-docs/language/matrices/#matrixsum-and-matrixdiff) functions, the `id1` and `id2` matrices must have the same
...
When using
[matrix.mult()](/pine-script-docs/language/matrices/#matrixmult) to multiply an `id1` matrix by an `id2` matrix or array, the
[matrix.rows()](https://www.tradingview.com/pine-script-reference/v6/#fun_matrix.rows)
or
[array.size()](https://www.tradingview.com/pine-script-reference/v6/#fun_array.size)
...
####       Arrays  
 ...
 ](/pine-script-docs/language/arrays)  [ Next
...
](#introduction)[- Declaring a matrix
](#declaring-a-matrix)[- Using `var` and `varip` keywords
](#using-var-and-varip-keywords)[- Reading and writing matrix elements
](#reading-and-writing-matrix-elements)[- `matrix.get()` and `matrix.set()`
](#matrixget-and-matrixset)[- `matrix.fill()`
](#matrixfill)[- Rows and columns
](#rows-and-columns)[- Retrieving
](#retrieving)[- Inserting
](#inserting)[- Removing
](#removing)[- Swapping
](#swapping)[- Replacing
](#replacing)[- Looping through a matrix
](#looping-through-a-matrix)[- `for`
](#for)[- `for...in`
](#forin)[- Copying a matrix
](#copying-a-matrix)[- Shallow copies
](#shallow-copies)[- Deep copies
](#deep-copies)[- Submatrices
](#submatrices)[- Scope and history
](#scope-and-history)[- Inspecting a matrix
](#inspecting-a-matrix)[- Manipulating a matrix
](#manipulating-a-matrix)[- Reshaping
](#reshaping)[- Reversing
](#reversing)[- Transposing
](#transposing)[- Sorting
](#sorting)[- Concatenating
](#concatenating)[- Matrix calculations
](#matrix-calculations)[- Element-wise calculations
](#element-wise-calculations)[- Special calculations
](#special-calculations)[- `matrix.sum()` and `matrix.diff()`
](#matrixsum-and-matrixdiff)[- `matrix.mult()`
](#matrixmult)[- `matrix.det()`
](#matrixdet)[- `matrix.inv()` and `matrix.pinv()`
](#matrixinv-and-matrixpinv)[- `matrix.rank()`
](#matrixrank)[- Error handling
](#error-handling)[- The row/column index (xx) is out of bounds, row/column size is (yy).
](#the-rowcolumn-index-xx-is-out-of-bounds-rowcolumn-size-is-yy)[- The array size does not match the number of rows or columns in the matrix.
](#the-array-size-does-not-match-the-number-of-rows-or-columns-in-the-matrix)[- Cannot call matrix methods when the ID of matrix is ‘na’.
](#cannot-call-matrix-methods-when-the-id-of-matrix-is-na)[- Matrix is too large. Maximum size of the matrix is 100,000 elements.
](#matrix-is-too-large-maximum-size-of-the-matrix-is-100000-elements)[- The row/column index must be 0 <= from_row/column < to_row/column.
](#the-rowcolumn-index-must-be-0--from_rowcolumn--to_rowcolumn)[- Matrices ‘id1’ and ‘id2’ must have an equal number of rows and columns to be added.
](#matrices-id1-and-id2-must-have-an-equal-number-of-rows-and-columns-to-be-added)[- The number of columns in the ‘id1’ matrix must equal the number of rows in the matrix (or the number of elements in the array) ‘id2’.
](#the-number-of-columns-in-the-id1-matrix-must-equal-the-number-of-rows-in-the-matrix-or-the-number-of-elements-in-the-array-id2)[- Operation not available for non-square matrices.
](#operation-not-available-for-non-square-matrices) [      ](#top)           -  [Pine Q&A chat](https://www.tradingview.com/chat/#BfmVowG1TZkKO235)  
