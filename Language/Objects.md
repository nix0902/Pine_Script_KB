...
- [To Pine Script® version 2](/pine-script-docs/migration-guides/to-pine-version-2)
- [Where can I get more information?](/pine-script-docs/where-can-i-get-more-information)
             [ User Manual  ](/pine-script-docs)  / [Language](/pine-script-docs/language/execution-model) / Objects   ADVANCED     
# [Objects](#objects)
...
[xloc.bar_index](https://www.tradingview.com/pine-script-reference/v6/#const_xloc%7Bdot%7Dbar_index)
or
[xloc.bar_time](https://www.tradingview.com/pine-script-reference/v6/#const_xloc%7Bdot%7Dbar_time).
...
of a
[user-defined type](/pine-script-docs/language/type-system/#user-defined-types), prefix the variable declaration with collection’s type keyword followed by its type template. For example:
...
![image](/pine-script-docs/_astro/Objects-CollectingObjects-1.Or5ovJGC_Zw2Kvh.webp)
...
[chart.point](https://www.tradingview.com/pine-script-reference/v6/#type_chart.point), [footprint](https://www.tradingview.com/pine-script-reference/v6/#type_footprint), or [volume_row](https://www.tradingview.com/pine-script-reference/v6/#type_volume_row)),
...
However, scripts cannot use the following keywords for [fundamental types](/pine-script-docs/language/type-system/#types) as names for UDTs:
...
####       User-defined functions  
 ...
 ](/pine-script-docs/language/user-defined-functions)  [ Next
...
](#introduction)[- Creating objects
](#creating-objects)[- Changing field values
](#changing-field-values)[- Collecting objects
](#collecting-objects)[- Copying objects
](#copying-objects)[- Shadowing
