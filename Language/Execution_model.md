...
**URL:** https://www.tradingview.com/pine-script-docs/language/execution-model/
...
- The [close](https://www.tradingview.com/pine-script-reference/v6/#var_close) variable automatically updates to hold the current bar’s latest price.

- The [plot()](https://www.tradingview.com/pine-script-reference/v6/#fun_plot) function call plots the updated [close](https://www.tradingview.com/pine-script-reference/v6/#var_close) value at the current bar’s position.
...
![image](/pine-script-docs/_astro/Execution-model-The-basics-Bar-by-bar-execution-1.D5nkQfFJ_1oCMgX.webp)
...
![image](/pine-script-docs/_astro/Execution-model-The-basics-Bar-by-bar-execution-2.CYV_XhNc_fPGku.webp)
...
![image](/pine-script-docs/_astro/Execution-model-The-basics-Bar-by-bar-execution-3.2eRg8rX8_ZUqlGK.webp)
...
![image](/pine-script-docs/_astro/Execution-model-The-basics-Storing-and-using-data-from-previous-bars-1.CZbtEkeL_Z28dT9i.webp)
...
![image](/pine-script-docs/_astro/Execution-model-The-basics-Realtime-bars-1.AOvj4-Z1_1svjXm.webp)
...
![image](/pine-script-docs/_astro/Execution-model-The-basics-Realtime-bars-2.C780uf5g_1ywlee.webp)
...
![image](/pine-script-docs/_astro/Execution-model-The-basics-Realtime-bars-3.rq8kAEPJ_Z2sy82e.webp)
...
![image](/pine-script-docs/_astro/Execution-model-Executions-on-historical-bars-1.CbmTx9jr_Z1leWpo.webp)
...
![image](/pine-script-docs/_astro/Execution-model-Executions-on-historical-bars-2.DpP1JZmD_2lzKqv.webp)
...
![image](/pine-script-docs/_astro/Execution-model-Executions-on-historical-bars-3.C3-PPUqF_Z9LtnE.webp)
...
[User-defined types (UDTs)](/pine-script-docs/language/type-system/#user-defined-types) and special types, such as [collections](/pine-script-docs/language/type-system/#collections) and [drawing types](/pine-script-docs/language/type-system/#drawing-types), are [reference types](/pine-script-docs/language/type-system/#reference-types). They define structures from which scripts create objects — independent entities that store data elsewhere in memory. Variables of these types hold references (IDs) that provide access to specific objects and their data; the variables do not store objects directly.
...
![image](/pine-script-docs/_astro/Execution-model-Executions-on-realtime-bars-1.C6ZIpkKC_Z1DmFI2.webp)
...
![image](/pine-script-docs/_astro/Execution-model-Executions-on-realtime-bars-2.DkBtTFWJ_wi3cQ.webp)
...
![image](/pine-script-docs/_astro/Execution-model-Executions-on-realtime-bars-3.5O5RsfWP_2oucrw.webp)
...
![image](/pine-script-docs/_astro/Execution-model-Executions-on-realtime-bars-4.C8UTIyzZ_1eXV6W.webp)
...
![image](/pine-script-docs/_astro/Execution-model-Events-that-trigger-script-executions-1.Bu_ElpOQ_Z25zgpA.webp)
...
![image](/pine-script-docs/_astro/Execution-model-Events-that-trigger-script-executions-2.CbIdk5sI_W8NUw.webp)
...
![image](/pine-script-docs/_astro/Execution-model-Events-that-trigger-script-executions-Caching-1.BY9-bg_Z_Z1h9UoE.webp)
...
![image](/pine-script-docs/_astro/Execution-model-Events-that-trigger-script-executions-Caching-2.DyVd2t5m_Z1wVpJs.webp)
...
![image](/pine-script-docs/_astro/Execution-model-Events-that-trigger-script-executions-Caching-3.ByASZdF6_Z1Va6dx.webp)
...
![image](/pine-script-docs/_astro/Execution-model-Events-that-trigger-script-executions-Caching-4.CGwk5hPj_ZgkqEL.webp)
...
![image](/pine-script-docs/_astro/Execution-model-Time-series-1.CzCPjlKh_1P3h3k.webp)
...
![image](/pine-script-docs/_astro/Execution-model-Time-series-2.tycqzMI6_AVJD9.webp)
...
- Call the [max_bars_back()](https://www.tradingview.com/pine-script-reference/v6/#fun_max_bars_back) function to explicitly set the historical buffer size for a specific series.
...
![image](/pine-script-docs/_astro/Execution-model-Time-series-Historical-buffers-1.BRNlhWd3_p17Kq.webp)
...
![image](/pine-script-docs/_astro/Execution-model-Time-series-Time-series-in-scopes-2.DnGQwjrs_Z2gROjb.webp)
...
](#the-basics)[- Bar-by-bar execution
](#bar-by-bar-execution)[- Storing and using data from previous bars
](#storing-and-using-data-from-previous-bars)[- Realtime bars
](#realtime-bars)[- The details
](#the-details)[- Executions on historical bars
](#executions-on-historical-bars)[- Executions on realtime bars
](#executions-on-realtime-bars)[- Events that trigger script executions
](#events-that-trigger-script-executions)[- Caching
](#caching)[- Time series
](#time-series)[- Historical buffers
](#historical-buffers)[- Time series in scopes
](#time-series-in-scopes) [      ](#top)           -  [Pine Q&A chat](https://www.tradingview.com/chat/#BfmVowG1TZkKO235)  
