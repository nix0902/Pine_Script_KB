...
**URL:** https://www.tradingview.com/pine-script-docs/language/operators/
...
OperatorMeaning`not`Negation`and`Logical Conjunction`or`Logical Disjunction
...
[time series](/pine-script-docs/language/execution-model/#time-series) using the
[[]](https://www.tradingview.com/pine-script-reference/v6/#op_%5B%5D)
...
PrecedenceOperator9`[]`8unary `+`, unary `-`, `not`7`*`, `/`, `%`6`+`, `-`5`>`, `<`, `>=`, `<=`4`==`, `!=`3`and`2`or`1`?:`
...
See the
[Variable declarations](/pine-script-docs/language/variable-declarations/) page for more information on how to declare variables.
...
[`var` declaration mode](/pine-script-docs/language/variable-declarations/#var):
...
![image](/pine-script-docs/_astro/Operators-ReassignmentOperator-1.D7pw1mZ8_Z2fUVUR.webp)
...
See the
[Variable reassignment](/pine-script-docs/language/variable-declarations/#variable-reassignment) section for more information on how to reassign values to
variables.
...
![image](/pine-script-docs/_astro/Operators-Compound-assignment-operators-1.CrQbM8TD_Z2nC2lD.webp)
...
####       Variable declarations  
 ...
 ](/pine-script-docs/language/variable-declarations)  [ Next
...
](#-ternary-operator)[- `[]` history-referencing operator
](#-history-referencing-operator)[- Operator precedence
](#operator-precedence)[- `=` assignment operator
](#-assignment-operator)[- `:=` reassignment operator
](#-reassignment-operator)[- Compound assignment operators
](#compound-assignment-operators) [      ](#top)           -  [Pine Q&A chat](https://www.tradingview.com/chat/#BfmVowG1TZkKO235)  
