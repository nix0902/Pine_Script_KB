...
**URL:** https://www.tradingview.com/pine-script-docs/faq/times-dates-and-sessions/
...
- [To Pine Script® version 2](/pine-script-docs/migration-guides/to-pine-version-2)
- [Where can I get more information?](/pine-script-docs/where-can-i-get-more-information)
             [ User Manual  ](/pine-script-docs)  / [FAQ](/pine-script-docs/faq) / Times, dates, and sessions        
...
The following example script initializes a variable using the [var](/pine-script-docs/language/variable-declarations/#var) keyword on the first bar and then never updates it again.
...
![image](/pine-script-docs/_astro/Times-dates-sessions-How-can-i-convert-a-time-to-a-date-time-string.D2uzseAs_Z2h7U0u.webp)
...
![image](/pine-script-docs/_astro/Times-dates-sessions-How-can-i-know-how-many-days-are-in-the-current-month-1.B9TubEEu_Z1VSzdL.webp)
...
![image](/pine-script-docs/_astro/Times-dates-sessions-How-can-i-plot-a-value-starting-n-months-years-back-1.DmQSNam2_HYAtB.webp)
...
![image](/pine-script-docs/_astro/Times-dates-sessions-How-can-i-track-highs-lows-for-a-specific-timeframe-1.CzQ5vZps_Vmwyy.webp)
...
![image](/pine-script-docs/_astro/Times-dates-sessions-How-can-i-track-the-highs-lows-within-a-specific-session-or-time-of-day-1.CKWpgvoE_i2qEW.webp)
...
![image](/pine-script-docs/_astro/Times-dates-sessions-How-can-i-track-highs-lows-between-specific-intrabar-hours-1.BEXeNwQA_2fjLL2.webp)
...
![image](/pine-script-docs/_astro/Times-dates-sessions-How-can-i-detect-a-specific-date-time-1.BRXAWfjw_Z26ERf4.webp)
...
![image](/pine-script-docs/_astro/Times-dates-sessions-How-can-i-know-the-date-when-the-highest-value-was-found-1.ScXUxlvD_Z13zsCr.webp)
...
Normally, variables reset every time the script performs a new iteration. This process is called rollback and is described in the [Execution model](/pine-script-docs/language/execution-model/#executions-on-realtime-bars) page of the User Manual.
...
![image](/pine-script-docs/_astro/Times-dates-sessions-Can-i-time-the-duration-of-a-condition-1.BgWHsjTH_TIPMh.webp)
...
![image](/pine-script-docs/_astro/Times-dates-sessions-How-can-i-identify-the-nth-occurance-of-a-weekday-in-the-month-1.-p0cMTpr_1vjPjM.webp)
...
![image](/pine-script-docs/_astro/Times-dates-sessions-How-can-i-implement-a-countdown-timer-1.f7Zg0trE_Z1bA1wA.webp)
...
####       Techniques  
 ...
 ](/pine-script-docs/faq/techniques)  [ Next
...
](#how-can-i-get-the-time-of-the-first-bar-in-the-dataset)[- How can I convert a time to a date-time string?
](#how-can-i-convert-a-time-to-a-date-time-string)[- How can I find out how many days are in the current month?
](#how-can-i-find-out-how-many-days-are-in-the-current-month)[- How can I detect the chart’s last day?
](#how-can-i-detect-the-charts-last-day)[- Using `timeframe.change`
](#using-timeframechange)[- Using `timenow`
](#using-timenow)[- How can I get bar’s trading date on symbols with an overnight session?
](#how-can-i-get-bars-trading-date-on-symbols-with-an-overnight-session)[- How can I plot a value starting n months or years back?
](#how-can-i-plot-a-value-starting-n-months-or-years-back)[- How can I track highs and lows for a specific timeframe?
](#how-can-i-track-highs-and-lows-for-a-specific-timeframe)[- How can I track the highs and lows within a specific session or time of day?
](#how-can-i-track-the-highs-and-lows-within-a-specific-session-or-time-of-day)[- How can I make an entire custom session visible?
](#how-can-i-make-an-entire-custom-session-visible)[- How can I track highs and lows for periods within a bar?
](#how-can-i-track-highs-and-lows-for-periods-within-a-bar)[- How can I detect a specific date and time?
](#how-can-i-detect-a-specific-date-and-time)[- How can I know the date when the highest value was found?
](#how-can-i-know-the-date-when-the-highest-value-was-found)[- How can I detect bars opening at a specific hour?
](#how-can-i-detect-bars-opening-at-a-specific-hour)[- Can I time the duration of a condition?
](#can-i-time-the-duration-of-a-condition)[- How can I identify the nth occurrence of a weekday in the month?
](#how-can-i-identify-the-nth-occurrence-of-a-weekday-in-the-month)[- How can I count down the remaining time in a bar?
](#how-can-i-count-down-the-remaining-time-in-a-bar)[- How can I get the week of the month?
](#how-can-i-get-the-week-of-the-month) [      ](#top)           -  [Pine Q&A chat](https://www.tradingview.com/chat/#BfmVowG1TZkKO235)  
