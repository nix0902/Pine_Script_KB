...
![image](/pine-script-docs/_astro/Visuals-Why-cant-i-use-a-plot-in-an-if-or-for-statement-1.3rjsIGWF_Z1AAQRi.webp)
...
![image](/pine-script-docs/_astro/Visuals-Can-i-plot-diagonals-between-two-points-on-the-chart-1.Dcpal7Wj_1QXb2x.webp)
...
![image](/pine-script-docs/_astro/Visuals-Can-i-plot-diagonals-between-two-points-on-the-chart-2.ZmicdTOe_Z1vv609.webp)
...
![image](/pine-script-docs/_astro/Visuals-How-can-i-plot-a-line-with-gaps-1.D6RMbvkI_25YWKB.webp)
...
![image](/pine-script-docs/_astro/Visuals-How-do-i-plot-a-line-using-start-stop-criteria-1.D0se5nwy_Z2vPKB6.webp)
...
![image](/pine-script-docs/_astro/Visuals-How-do-i-plot-a-support-or-a-trend-line-1.zCbz0Lc8_ZAn82Y.webp)
...
![image](/pine-script-docs/_astro/Visuals-How-do-i-plot-a-support-or-a-trend-line-2.CDeAY9mr_ZHDbMR.webp)
...
![image](/pine-script-docs/_astro/Visuals-How-can-i-use-colors-in-my-indicator-plots-1.Cp4v-X8j_1uxHru.webp)

![image](/pine-script-docs/_astro/Visuals-How-can-i-use-colors-in-my-indicator-plots-2.BUNwe5Dz_Z17G4Vs.webp)
...
### [Using bar_index](#using-bar_index)
...
![image](/pine-script-docs/_astro/Visuals-How-can-i-draw-lines-or-labels-into-the-future-1.jzxOMGSo_10l2GW.webp)
...
- Create an array containing objects of type [chart.point](https://www.tradingview.com/pine-script-reference/v6/#type_chart.point) that define the vertices of your desired shape.

- Pass this array to the [polyline.new()](https://www.tradingview.com/pine-script-reference/v6/#fun_polyline.new) function. This function draws sequential lines between the points in the order they appear in the array.
...
![image](/pine-script-docs/_astro/Visuals-Is-it-possible-to-draw-geometric-shapes-1.ChBhMig6_Z1cPYDn.webp)
...
![image](/pine-script-docs/_astro/Visuals-Is-it-possible-to-draw-geometric-shapes-2.DEB53-5u_Z1mummy.webp)
...
](#why-cant-i-use-a-plot-in-an-if-or-for-statement)[- Can I plot diagonals between two points on the chart?
](#can-i-plot-diagonals-between-two-points-on-the-chart)[- Using plots
](#using-plots)[- Using lines
](#using-lines)[- How can I plot a line with gaps?
](#how-can-i-plot-a-line-with-gaps)[- How do I plot a line using start/stop criteria?
](#how-do-i-plot-a-line-using-startstop-criteria)[- How can I plot a support or trend line?
](#how-can-i-plot-a-support-or-trend-line)[- Plotting support and resistance
](#plotting-support-and-resistance)[- Plotting trend lines
](#plotting-trend-lines)[- How can I use colors in my indicator plots?
](#how-can-i-use-colors-in-my-indicator-plots)[- How do I make my indicator plot in the main chart pane?
](#how-do-i-make-my-indicator-plot-in-the-main-chart-pane)[- How can I plot vertical lines on a chart?
](#how-can-i-plot-vertical-lines-on-a-chart)[- By drawing lines
](#by-drawing-lines)[- By plotting histograms
](#by-plotting-histograms)[- By coloring the background
](#by-coloring-the-background)[- How can I toggle hline() levels on and off?
](#how-can-i-toggle-hline-levels-on-and-off)[- How can I draw lines or labels into the future?
](#how-can-i-draw-lines-or-labels-into-the-future)[- Using bar_index
](#using-bar_index)[- Using time
](#using-time)[- How can I keep only the last n number of drawings?
](#how-can-i-keep-only-the-last-n-number-of-drawings)[- Using a `*.all` array
](#using-a-all-array)[- Using an array as a queue
](#using-an-array-as-a-queue)[- Is it possible to draw geometric shapes?
](#is-it-possible-to-draw-geometric-shapes)[- Drawing with polylines
](#drawing-with-polylines)[- Drawing with lines
](#drawing-with-lines)[- How can I color the chart’s background on a condition detected on the last bar?
](#how-can-i-color-the-charts-background-on-a-condition-detected-on-the-last-bar) [      ](#top)           -  [Pine Q&A chat](https://www.tradingview.com/chat/#BfmVowG1TZkKO235)  
