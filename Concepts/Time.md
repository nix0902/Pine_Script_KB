...
**URL:** https://www.tradingview.com/pine-script-docs/concepts/time/
...
![image](/pine-script-docs/_astro/Time-Unix-timestamps-1.CTbXturQ_ZA7lsx.webp)
...
![image](/pine-script-docs/_astro/Time-Time-zones-1.BAv9QYBX_jNyY.webp)
...
![image](/pine-script-docs/_astro/Time-Time-zones-Time-zone-strings-1.CWMAwPYS_ZN7mN7.webp)
...
![image](/pine-script-docs/_astro/Time-Time-zones-Time-zone-strings-2.Bgcl5BRA_Z1UUd3e.webp)
...
![image](/pine-script-docs/_astro/Time-Time-zones-Time-zone-strings-3.dJwwxe9V_1a20aC.webp)
...
![image](/pine-script-docs/_astro/Time-Time-variables-Time-and-time-close-1.SQRlfJYt_Z2oHBgb.webp)
...
When applied to a [Renko](https://www.tradingview.com/support/solutions/43000502284/) chart, which forms new bars based on price movements, the labels show correct results on all historical bars. However, the last bar has a [time_close](https://www.tradingview.com/pine-script-reference/v6/#var_time_close) value of [na](https://www.tradingview.com/pine-script-reference/v6/#var_na) because the future closing time is unpredictable. Consequently, the bar’s closing time label shows a timestamp of `"NaN"` and an incorrect date and time:

![image](/pine-script-docs/_astro/Time-Time-variables-Time-and-time-close-2.DgbsHPgj_1bCOHq.webp)
...
![image](/pine-script-docs/_astro/Time-Time-variables-Time-and-time-close-3.n-klv93m_Z1gi8Rh.webp)
...
![image](/pine-script-docs/_astro/Time-Time-variables-Time-tradingday-1.oi6pPbd1_Z2d200U.webp)
...
- The [time_tradingday](https://www.tradingview.com/pine-script-reference/v6/#var_time_tradingday) value is the same for all three-hour bars within each session, even for the initial bar that opens on the previous UTC calendar day. The assigned timestamp changes only when a new session starts.
...
![image](/pine-script-docs/_astro/Time-Time-variables-Timenow-1.OYWKIkvY_Z1MUwEq.webp)
...
![image](/pine-script-docs/_astro/Time-Time-variables-Calendar-based-variables-1.kYa8Z75h_KDMyu.webp)
...
![image](/pine-script-docs/_astro/Time-Time-variables-Calendar-based-variables-2.xQSXmhyL_Zw0zRE.webp)
...
- The script calls the [month()](https://www.tradingview.com/pine-script-reference/v6/#fun_month) function with [time_close](https://www.tradingview.com/pine-script-reference/v6/#var_time_close) as the `time` argument to calculate each bar’s closing month for the `containsFirst` condition.
...
As the chart below shows, both drawings display identical times, verifying that [last_bar_time](https://www.tradingview.com/pine-script-reference/v6/#var_last_bar_time) correctly references the last bar’s [time](https://www.tradingview.com/pine-script-reference/v6/#var_time) value on previous historical bars:

![image](/pine-script-docs/_astro/Time-Time-variables-Last-bar-time-1.COWu3Po-_Z26jRdL.webp)
...
![image](/pine-script-docs/_astro/Time-Time-variables-Visible-bar-times-1.Cm54dJVW_rV6wP.webp)
...
![image](/pine-script-docs/_astro/Time-Time-variables-Syminfo-timezone-1.BAiDPB0L_Z1tzhco.webp)
...
![image](/pine-script-docs/_astro/Time-Time-functions-Time-and-time-close-Testing-for-sessions-1.CJeOvGxZ_Z1sBkKc.webp)
...
![image](/pine-script-docs/_astro/Time-Time-functions-Time-and-time-close-Testing-for-sessions-2.DKRpvO46_Z1pg5HR.webp)
...
![image](/pine-script-docs/_astro/Time-Time-functions-Time-and-time-close-Testing-for-changes-in-higher-timeframes-1.EwKXV91R_16xSC0.webp)
...
![image](/pine-script-docs/_astro/Time-Time-functions-Time-and-time-close-functions-Calculating-timestamps-at-bar-offsets-1.DcEMMg3B_RUoKE.webp)
...
![image](/pine-script-docs/_astro/Time-Time-functions-Time-and-time-close-functions-Calculating-timestamps-at-bar-offsets-2.CrnGcGog_Z1sVFWd.webp)
...
![image](/pine-script-docs/_astro/Time-Time-functions-Time-and-time-close-functions-Calculating-timestamps-at-bar-offsets-3.CwaV-eSs_17y787.webp)
...
![image](/pine-script-docs/_astro/Time-Time-functions-Calendar-based-functions-1.7yz46qU5_56taF.webp)
...
![image](/pine-script-docs/_astro/Time-Time-functions-Calendar-based-functions-2.CLs3hZaQ_Z1mTUCj.webp)
...
![image](/pine-script-docs/_astro/Time-Time-functions-Calendar-based-functions-3.BgN06lg1_1QVzL3.webp)
...
timestamp(timezone, year, month, day, hour, minute, second) → simple/series inttimestamp(dateString) → const int
...
![image](/pine-script-docs/_astro/Time-Time-functions-Timestamp-1.CFLoCdL8_A5DD7.webp)
...
![image](/pine-script-docs/_astro/Time-Formatting-dates-and-times-1.BsC0g9qz_29jz4f.webp)
...
![image](/pine-script-docs/_astro/Time-Relative-time-differences-1.Bn5sSvwp_ZWpy0r.webp)
...
![image](/pine-script-docs/_astro/Time-Relative-time-differences-Weekly-and-smaller-units-1.CkIHycnQ_yxUkv.webp)
...
![image](/pine-script-docs/_astro/Time-Relative-time-differences-Weekly-and-smaller-units-2.CwvuIXRj_ZdIqWW.webp)
...
![image](/pine-script-docs/_astro/Time-Relative-time-differences-Monthly-and-larger-units-1.BhYyGmym_1QIbUd.webp)
...
####       Strings  
 ...
 ](/pine-script-docs/concepts/strings)  [ Next
...
[- Introduction
](#introduction)[- UNIX timestamps
](#unix-timestamps)[- Time zones
](#time-zones)[- Time zone strings
](#time-zone-strings)[- Time variables
](#time-variables)[- `time` and `time_close` variables
](#time-and-time_close-variables)[- `time_tradingday`
](#time_tradingday)[- `timenow`
](#timenow)[- Calendar-based variables
](#calendar-based-variables)[- `last_bar_time`
](#last_bar_time)[- Visible bar times
](#visible-bar-times)[- `syminfo.timezone`
](#syminfotimezone)[- Time functions
](#time-functions)[- `time()` and `time_close()` functions
](#time-and-time_close-functions)[- Testing for sessions
](#testing-for-sessions)[- Testing for changes in higher timeframes
](#testing-for-changes-in-higher-timeframes)[- Calculating timestamps at bar offsets
](#calculating-timestamps-at-bar-offsets)[- Calendar-based functions
](#calendar-based-functions)[- `timestamp()`
](#timestamp)[- Formatting dates and times
](#formatting-dates-and-times)[- Expressing time differences
](#expressing-time-differences)[- Weekly and smaller units
](#weekly-and-smaller-units)[- Monthly and larger units
](#monthly-and-larger-units) [      ](#top)           -  [Pine Q&A chat](https://www.tradingview.com/chat/#BfmVowG1TZkKO235)  
