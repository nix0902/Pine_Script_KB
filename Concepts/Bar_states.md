...
[Session states](/pine-script-docs/concepts/sessions/#session-variables-reference) section.
...
![image](/pine-script-docs/_astro/BarStates-Example-01.C2adOFU8_1Hn1tm.webp)

Let’s look at what happens when realtime updates start coming in:

![image](/pine-script-docs/_astro/BarStates-Example-02.B_WDB0Io_Z2snO6O.webp)
...
![image](/pine-script-docs/_astro/BarStates-Example-03.DTQntSqN_1JGkwK.webp)
...
####       Alerts  
 ...
 ](/pine-script-docs/concepts/alerts)  [ Next
...
](#bar-state-built-in-variables)[- `barstate.isfirst`
](#barstateisfirst)[- `barstate.islast`
](#barstateislast)[- `barstate.ishistory`
](#barstateishistory)[- `barstate.isrealtime`
](#barstateisrealtime)[- `barstate.isnew`
](#barstateisnew)[- `barstate.isconfirmed`
](#barstateisconfirmed)[- `barstate.islastconfirmedhistory`
](#barstateislastconfirmedhistory)[- Example
](#example) [      ](#top)           -  [Pine Q&A chat](https://www.tradingview.com/chat/#BfmVowG1TZkKO235)  
