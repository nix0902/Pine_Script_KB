...
**URL:** https://www.tradingview.com/pine-script-docs/concepts/strings/
...
![image](/pine-script-docs/_astro/Strings-Literal-strings-1.UPGL89sk_Z1kHuDV.webp)
...
![image](/pine-script-docs/_astro/Strings-Escape-sequences-1.BXm3Bx6T_ZF0kjn.webp)
...
![image](/pine-script-docs/_astro/Strings-Escape-sequences-2.Cg3hFdcW_J8QOA.webp)
...
![image](/pine-script-docs/_astro/Strings-Concatenation-1.NzTI46eF_ZvFdsr.webp)
...
![image](/pine-script-docs/_astro/Strings-String-conversion-and-formatting-Converting-values-to-strings-1.DbfJ2rm8_zI2Ay.webp)
...
![image](/pine-script-docs/_astro/Strings-String-conversion-and-formatting-Formatting-strings-1.B6WKMYIo_1y4KGB.webp)
...
![image](/pine-script-docs/_astro/Strings-String-conversion-and-formatting-Formatting-strings-2.BltxB35B_hlmcG.webp)
...
![image](/pine-script-docs/_astro/Strings-String-conversion-and-formatting-Formatting-strings-3.C4oE7UGv_Z1gc7ac.webp)
...
if barstate.islast
    ...
    //@variable Represents the `value` using the `currency` preset (`&#39;___PINE_CODE_BLOCK___9___PINE_CODE_BLOCK___#39;#,###.00`). 
    //          This format prefixes the result with the ` Concepts / Strings
...
![image](/pine-script-docs/_astro/Strings-String-conversion-and-formatting-Formatting-strings-3.C4oE7UGv_Z1gc7ac.webp)
 ...
 symbol, adds comma separation for sets of three whole 
    //          digits, and includes two fractional digits. 
    string currencyPreset = str.format("{0,number,currency}", value)
    //@variable Represents the `value` in dollars with comma-separated whole digits and four fractional digits (`&#39;___PINE_CODE_BLOCK___9___PINE_CODE_BLOCK___#39;,###.0000`). 
    string currencyCustom = str.format("{0,number,&#39;___PINE_CODE_BLOCK___9___PINE_CODE_BLOCK___#39;,###.0000}", value)
    ...
    makeRow(4, "currency (&#39;___PINE_CODE_BLOCK___9___PINE_CODE_BLOCK___#39;#,###.00)",                              currencyPreset)
    makeRow(5, "currency with 4 fractional digits (&#39;___PINE_CODE_BLOCK___9___PINE_CODE_BLOCK___#39;,###.0000)",    currencyCustom)
...
![image](/pine-script-docs/_astro/Strings-String-conversion-and-formatting-Custom-representations-1.XcnqrSgw_2taBpW.webp)
...
The [str.replace_all()](https://www.tradingview.com/pine-script-reference/v6/#fun_str.replace_all) function searches the `source` for every non-overlapping occurrence of the substring and replaces each one in its returned value.
...
![image](/pine-script-docs/_astro/Strings-Modifying-strings-Replacing-substrings-1.Bu9H-So3_Z1xDtOH.webp)
...
- The `str.replace*()` functions can replace zero-width boundaries when the `target` is an empty string, as shown by the `formatString` declaration. The [str.replace_all()](https://www.tradingview.com/pine-script-reference/v6/#fun_str.replace_all) call inserts `}\n{` around every character in the literal string `"012345"`.
...
![image](/pine-script-docs/_astro/Strings-Modifying-strings-Changing-case-1.7yrRmoQ__Z1bjY0c.webp)
...
![image](/pine-script-docs/_astro/Strings-Modifying-strings-Changing-case-2.aOK3qDyt_2fqNuJ.webp)
...
![image](/pine-script-docs/_astro/Strings-Modifying-strings-Trimming-whitespaces-1.Pw-iWToN_2wcbYS.webp)
...
![image](/pine-script-docs/_astro/Strings-Modifying-strings-Trimming-whitespaces-2.DXeJgZMp_1HaN4n.webp)
...
![image](/pine-script-docs/_astro/Strings-Modifying-strings-Repeating-sequences-1.Crzgj3dM_ZmXEeu.webp)
...
![image](/pine-script-docs/_astro/Strings-Modifying-strings-Repeating-sequences-2.t0jtjbMv_2stnSa.webp)
...
![image](/pine-script-docs/_astro/Strings-String-inspection-and-extraction-Counting-characters-and-substrings-1.BDBO3GAa_Zvh5Jx.webp)
...
![image](/pine-script-docs/_astro/Strings-String-inspection-and-extraction-Counting-characters-and-substrings-2.C5OGeI0L_Z1zNoWF.webp)
...
str.startswith(source, str) → boolstr.endswith(source, str) → bool
Where:
...
![image](/pine-script-docs/_astro/Strings-String-inspection-and-extraction-Checking-for-substrings-1.VmIRjjPH_1mWWQF.webp)
...
![image](/pine-script-docs/_astro/Strings-String-inspection-and-extraction-Splitting-strings-1.CnHbOLag_Z2bvbAu.webp)
...
![image](/pine-script-docs/_astro/Strings-String-inspection-and-extraction-Locating-and-retrieving-substrings-1.BMr53GtF_Z12LWpe.webp)
...
![image](/pine-script-docs/_astro/Strings-String-inspection-and-extraction-Locating-and-retrieving-substrings-2.CmNJVVN6_Z2899pm.webp)
...
![image](/pine-script-docs/_astro/Strings-String-inspection-and-extraction-Matching-patterns-1.CiTTTCok_Z4gXAH.webp)
...
![image](/pine-script-docs/_astro/Strings-String-inspection-and-extraction-Matching-patterns-2.CvX-NVT1_CiLGG.webp)
...
![image](/pine-script-docs/_astro/Strings-String-inspection-and-extraction-Matching-patterns-2.CvX-NVT1_CiLGG.webp)
 ...
 at the end matches the end of the text line. 
    ...
    //          `^ *(?:(?:\w+:)?\w+(?:\.\w+){0,2}!? *, *)*(?:\w+:)?\w+(?:\.\w+){0,2}!? * Concepts / Strings
...
[- Introduction
](#introduction)[- Literal strings
](#literal-strings)[- Escape sequences
](#escape-sequences)[- Concatenation
](#concatenation)[- String conversion and formatting
](#string-conversion-and-formatting)[- Converting values to strings
](#converting-values-to-strings)[- Formatting strings
](#formatting-strings)[- Custom representations
](#custom-representations)[- Modifying strings
](#modifying-strings)[- Replacing substrings
](#replacing-substrings)[- Changing case
](#changing-case)[- Trimming whitespaces
](#trimming-whitespaces)[- Repeating sequences
](#repeating-sequences)[- String inspection and extraction
](#string-inspection-and-extraction)[- Counting characters and substrings
](#counting-characters-and-substrings)[- Checking for substrings
](#checking-for-substrings)[- Splitting strings
](#splitting-strings)[- Locating and retrieving substrings
](#locating-and-retrieving-substrings)[- Matching patterns
](#matching-patterns)[- Regex syntax reference
](#regex-syntax-reference) [      ](#top)           -  [Pine Q&A chat](https://www.tradingview.com/chat/#BfmVowG1TZkKO235)  
