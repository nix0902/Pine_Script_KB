...
[Historical and realtime behavior](/pine-script-docs/concepts/other-timeframes-and-data/#historical-and-realtime-behavior) section of the
[Other timeframes and data](/pine-script-docs/concepts/other-timeframes-and-data/) page. As with the unconfirmed chart bar in the chart’s
timeframe,
[request.security()](https://www.tradingview.com/pine-script-reference/v6/#fun_request.security)
...
[non-standard charts](/pine-script-docs/concepts/non-standard-charts-data/), and scripts using realtime intrabars to generate alerts
...
[publish](/pine-script-docs/writing/publishing/) scripts, ensure
...
[publish](/pine-script-docs/writing/publishing/) your script,
...
![image](/pine-script-docs/_astro/Repainting-01.B4bnEQz8_PQ677.webp)
...
[Historical and realtime behavior](/pine-script-docs/concepts/other-timeframes-and-data/#historical-and-realtime-behavior) section of the
[Other timeframes and data](/pine-script-docs/concepts/other-timeframes-and-data/) page for a detailed explanation.
...
[request.security()](https://www.tradingview.com/pine-script-reference/v6/#fun_request.security)
call, as explained
[here](/pine-script-docs/concepts/other-timeframes-and-data/#higher-timeframe-data).
...
![image](/pine-script-docs/_astro/Repainting-Repainting-request-security-calls-1.DKoD6okt_2uKSkR.webp)
...
as explained in
[this](/pine-script-docs/concepts/other-timeframes-and-data/#lower-timeframe-data) section of the
[Other timeframes and data](/pine-script-docs/concepts/other-timeframes-and-data/) page.
...
![image](/pine-script-docs/_astro/Repainting-FutureLeakWithRequestSecurity-01.B8DsNHGV_Kgu8T.webp)
...
[this previous section](/pine-script-docs/concepts/repainting/#repainting-requestsecurity-calls).

Using lookahead to produce misleading results is not allowed in script
publications, as explained in the
[lookahead](/pine-script-docs/concepts/other-timeframes-and-data/#lookahead) section of the
[Other timeframes and data](/pine-script-docs/concepts/other-timeframes-and-data/) page. Script publications that use this misleading technique
will be moderated.
...
Scripts using [bar states](/pine-script-docs/concepts/bar-states/)
...
![image](/pine-script-docs/_astro/Repainting-PlottingInThePast-01.CdfEKXRh_VvvoS.webp)
...
on Pine Script’s
[execution model](/pine-script-docs/language/execution-model/). If
...
####       Other timeframes and data  
 ...
 ](/pine-script-docs/concepts/other-timeframes-and-data)  [ Next
...
[- Introduction
](#introduction)[- For script users
](#for-script-users)[- For Pine Script programmers
](#for-pine-script-programmers)[- Historical vs realtime calculations
](#historical-vs-realtime-calculations)[- Fluid data values
](#fluid-data-values)[- Repainting `request.security()` calls
](#repainting-requestsecurity-calls)[- Using `request.security()` at lower timeframes
](#using-requestsecurity-at-lower-timeframes)[- Future leak with `request.security()`
](#future-leak-with-requestsecurity)[- `varip`
](#varip)[- Bar state built-ins
](#bar-state-built-ins)[- `timenow`
](#timenow)[- Strategies
](#strategies)[- Plotting in the past
](#plotting-in-the-past)[- Dataset variations
](#dataset-variations)[- Starting points
](#starting-points)[- Revision of historical data
](#revision-of-historical-data) [      ](#top)           -  [Pine Q&A chat](https://www.tradingview.com/chat/#BfmVowG1TZkKO235)  
